...
#PATH = os.getcwd()
#model = load(rf"C:\Users\Muska\Downloads\Prakriti-Determin-main\Prakriti-Determin-main\bot\models\nlm")
#prakrit_model = load(rf"C:\Users\Muska\Downloads\Prakriti-Determin-main\Prakriti-Determin-main\bot\models\trained_model")

# Importing the Sentence intent .csv file
df = pd.read_csv(rf"C:\Users\Muska\Downloads\Prakriti-Determin-main\Prakriti-Determin-main\Dataset\sentences_intent.csv")

# Importing the json file for getting the responses
with open(rf"C:\Users\Muska\Downloads\Prakriti-Determin-main\Prakriti-Determin-main\bot\intents.json", "r") as f:
